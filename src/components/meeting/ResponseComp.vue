    ...
    <teleport to="#portal-target" v-if="isAddTimeSlot">
      ...
      <div class="pop-up">
        <div class="top-container">
          <div class="title remark-text">{{text['toBeConfirmed']['timeslots']}} <div class="suggest">({{text['toBeConfirmed']['suggest']}})</div></div>
