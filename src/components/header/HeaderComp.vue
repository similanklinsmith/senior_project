  ...
  <div class="container-header grid">
    ...
    <div class="last-section">
      ...
      <div class="language" @click="toggleLanguageDropdown">
        ...
        >
          <ul>
            <li><div class="bold-small-text" @click="changeLanguage('th')" :style="lang == 'th' ? {color: '#7452FF'} : {}">TH-ภาษาไทย</div></li>
            <li><div class="line" /></li>
            <li><div class="bold-small-text" @click="changeLanguage('en')" :style="lang == 'en' ? {color: '#7452FF'} : {}">EN-English</div></li>
          </ul>
        </div>
      </div>
    </div>
...
.container-header {
  ...
  align-items: center;
  grid-template-columns: 0.6fr 1.25fr 1.1fr;
  padding: 3rem 5.5rem 3rem 18rem;
  .remark-text {
    color: var(--colorTextHeaderComp);
  }
  .search-input {
    width: 100%;
    position: relative;
  ...
  .notification:hover {
    background-color: var(--notiHover);
    .icon {
