...
.container-header {width: 100%;height: 10rem;background-color: $white;align-items: center;grid-template-columns: 0.75fr 1.5fr 1fr;padding: 3rem 5.5rem 3rem 18rem;.remark-text {color: $darkViolet;}.search-input {width: 100%;position: relative;display: flex;align-items: center;justify-items: center;.input-icon {width: 100%;position: absolute;display: flex;align-items: center;justify-items: center;
