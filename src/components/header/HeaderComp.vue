      ...
      <div class="profile" @click="toggleProfileDropdown">
        ...
        />
            ...
            <li>
              ...
              <div class="thin-content-text" @click="$router.push({ path: '/setting' })">Edit profile</div>
            </li>
            <li><div class="line" /></li>
            <li>
              <div class="icon-container">
...
ul {width: 100%;list-style: none;li {gap:2rem;.icon-container{height: 3.6rem; width:3.6rem; border-radius: 1rem; display: flex; justify-content: center; align-items: center; background-color: $fadedViolet;}color: $darkViolet;display: flex;align-items: center;justify-content: flex-start;transition: 0.3s all ease-in-out;.icon {font-size: 1.4rem;margin-right: 1rem;transition: 0.3s all ease-in-out;}.line {width: 100% !important;margin: 1.5rem 0;height: 0.1rem;background-color: $grey;}}li:hover {color: $primaryViolet;.icon {color: $primaryViolet !important;}}}
