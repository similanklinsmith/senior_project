...
export default {
  ...
  methods: {
    ...
    onBlur() {document.getElementById("search-input").placeholder = "Search anything";},
...
@media (max-width: 60em) {.container-header{grid-template-columns: 0.65fr 1.35fr 1.35fr;.last-section,.notification {margin-right: 2rem;}} }
