...
.attendees {display: flex;column-gap: 2rem;.real-profile-image {border-radius: 1.6rem;width: 6rem;height: 6rem;overflow: hidden;img {height: 100%;width: 100%;object-fit: cover;}}.profile-image {border-radius: 1.6rem;width: 6rem;height: 6rem;background-color: $fadedViolet;padding: 0.8rem;img {width: 100%;height: 100%;}}.attendee,.attendee-more {cursor: pointer;width: 6rem;height: 6rem;border-radius: 0.5rem;background-color: $fadedViolet;display: flex;justify-content: center;align-items: center;}.attendee-more {background-color: $grey;color: $primaryViolet;}}
