  ...
  <div class="home">
    ...
    <div class="body">
      ...
      <div class="second-body-section">
        ...
        <div v-if="getterLoadingStatus" class="remark-text not-found loading">{{text['executive']['loading']}}</div>
        <div class="incoming-meetings" v-else-if="getIncomingList.length > 0">
          <AttendeeGroup
